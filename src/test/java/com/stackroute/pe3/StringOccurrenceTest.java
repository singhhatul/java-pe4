...
public class StringOccurrenceTest {
    ...
    */
    ...
    public void givenInputShouldNull() {
        ...
        String actualOutput = occurrence.occurrrenceOfString(null, "ab");
        assertEquals(expectedOutput, actualOutput);
    }
    @Test
    public void givenStringInputShouldReturnNotFoundMessage() {
        String actualResult = "not found in the string";
        String expectedResult = occurrence.occurrrenceOfString("She sells seashells by the seashore", "at");
        assertEquals(expectedResult, actualResult);
